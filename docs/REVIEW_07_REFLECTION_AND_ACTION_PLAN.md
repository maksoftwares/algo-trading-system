...
| --- | --- |
| N8 - codify diversification result | Added `xau-usd/xauusd-phase0/docs/DIVERSIFICATION_AVAILABILITY_FINDING.md`. It records that ten non-level H4/D1/W1 candidates were hash-locked, tested, and rejected first-pass. |
