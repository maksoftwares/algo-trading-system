...
| --- | --- |
| N8 - codify diversification result | Added and refreshed `xau-usd/xauusd-phase0/docs/DIVERSIFICATION_AVAILABILITY_FINDING.md`. It records that twenty-two non-level H4/D1/W1 candidates plus additional H1 intermarket and volatility-regime candidates were hash-locked, tested, and rejected first-pass. |
