...
def main() -> int:
    parser = argparse.ArgumentParser(description="Acquire completed prospective XAU hours")
    parser.add_argument("--end-exclusive", help="UTC hour, default current completed-hour boundary")
