...
REPO = ROOT.parents[2]
SOURCE = ROOT / "mt5" / "Experts" / "EurUsdM30RsiBbCloseFadeLongV1R.mq5"
PRESET = ROOT / "mt5" / "Presets" / "EURUSD_M30_RSI_BB_CLOSE_FADE_LONG_V1R_UNMASKED_CONTRACT.set"
OUTPUT = ROOT / "outputs"
RUN_OUTPUT = OUTPUT / "mt5"
LOCKED = OUTPUT / "locked"
EA_NAME = "EurUsdM30RsiBbCloseFadeLongV1R"
REPORT_BASE = "EURUSD_V1R_UNMASKED_CONTRACT"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the exact EURUSD V1R contract-repair baseline.")
    ...
    trade_path = RUN_OUTPUT / "EURUSD_V1R_TRADE_LEDGER.csv"
    ...
    summary = {
        "schema_version": "eurusd_v1r_exact_mt5_result_v1",
        "candidate_id": CANDIDATE_ID,
        "status": "STAGE0_MT5_RUN_COMPLETE_PARITY_NOT_YET_ADJUDICATED",
        "boundary": {
    ...
    summary_path = RUN_OUTPUT / "EURUSD_V1R_EXACT_MT5_RESULT.json"
