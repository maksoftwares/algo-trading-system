...
def test_asia_range_london_failed_break_reversal_v0_generates_short_market_plan():
    strategy = AsiaRangeLondonFailedBreakReversalV0Strategy()
    context = synthetic_context_for_expert("asia_range_london_failed_break_reversal_v0")
...
def test_asia_range_london_failed_break_reversal_v0_ignores_without_reclaim_inside():
    strategy = AsiaRangeLondonFailedBreakReversalV0Strategy()
    context = synthetic_context_for_expert("asia_range_london_failed_break_reversal_v0")
    m5 = context["M5"].copy()
    m5.loc[90, "close"] = 101.10
    context["M5"] = m5

    assert strategy.generate_signals(context) == []


def test_asia_range_london_failed_break_reversal_v0_ignores_when_not_london_window():
    strategy = AsiaRangeLondonFailedBreakReversalV0Strategy()
    context = synthetic_context_for_expert("asia_range_london_failed_break_reversal_v0")
    m5 = context["M5"].copy()
...
def test_asia_range_london_failed_break_reversal_v0_supports_failed_low_long_plan():
    strategy = AsiaRangeLondonFailedBreakReversalV0Strategy()
    context = synthetic_context_for_expert("asia_range_london_failed_break_reversal_v0")
    m5 = context["M5"].copy()
    m5.loc[90, ["open", "high", "low", "close"]] = [98.70, 99.60, 98.40, 99.40]
    context["M5"] = m5
...
def test_asia_range_london_failed_break_reversal_v0_synthetic_timestamps_are_complete():
    context = synthetic_context_for_expert("asia_range_london_failed_break_reversal_v0")
