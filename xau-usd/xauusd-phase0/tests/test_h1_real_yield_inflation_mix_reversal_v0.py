...
def test_h1_real_yield_inflation_mix_reversal_synthetic_generates_signal() -> None:
    expert = "h1_real_yield_inflation_mix_reversal_v0"
...
def test_h1_real_yield_inflation_mix_reversal_trade_plan_has_valid_risk() -> None:
    expert = "h1_real_yield_inflation_mix_reversal_v0"
    strategy = get_strategy(expert, allow_research_candidate=True)
    context = synthetic_context_for_expert(expert)
