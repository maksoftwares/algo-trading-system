# H1 VIX Term-Structure Inversion Reversal v0 Hypothesis

Hypothesis date: 2026-05-30
Hypothesis version: v0
Author / owner: maksoftwares / Codex
Mechanic family: VIX/VXV equity-volatility term-structure inversion reversal
...
Expected R-multiple distribution: Many 1R losses, occasional 1.5R reversal winners after VIX term-structure inversion or relief. Reject if results require changing term-structure thresholds, confirmation rules, stop, target, or time stop after first-pass evidence.
...
`h1_vix_term_structure_inversion_reversal_v0` tests whether shifted VIX/VXV term-structure inversion identifies short-term XAU H1 exhaustion better than absolute VIX level alone.
...
Expected PF: at least 1.30 in 7 of 9 matrix cells if VIX term-structure inversion contains tradable XAU exhaustion information.
...
Absolute VIX level is broad and indirect. VIX/VXV term-structure inversion is a sharper stress signal because it measures near-term equity-volatility demand versus 3-month volatility. A sudden front-volatility premium can mark panic-like conditions. If XAU has already moved strongly into that panic and then prints a completed H1 reversal candle, the next few hours may mean-revert without relying on price levels or breakout/retest structure.
