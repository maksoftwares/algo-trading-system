...
As of 2026-05-30, the project has tested a broad set of non-level, intermarket, macro-regime, AI-style macro-composite, policy-uncertainty, nominal-rate, yield-curve, corporate-credit, futures-positioning, options-implied-volatility, equity-risk implied-volatility, GVZ/VIX relative volatility-premium, GVZ/realized-volatility spread, MOVE/VIX bond-volatility stress, real-yield / breakeven-inflation mix, official CNY-dollar pressure, direct HG/GC copper-gold futures rotation, GC/XAU futures-spot basis, GC futures-proxy momentum, official CFTC COT continuation, calendar-flow, session impulse-reversion, Friday position-squaring, weekend/market-break gap reversion, financial-conditions, breakeven-inflation, volatility-regime, event-regime, non-authoritative futures-volume proxy, public GLD ETF flow proxy, public GDX/GLD miner-relative proxy, public FX ETF rotation proxies, and higher-timeframe XAUUSD candidates under the locked Phase 0 research lane. Twenty-nine H4/D1/W1 candidates plus additional H1 intermarket, volatility-regime, event-regime, ETF-relative, ETF-flow, macro-composite, macro-decomposition, macro/FX pressure, calendar-flow, session impulse-reversion, Friday position-squaring, weekend/market-break gap reversion, volatility-premium, futures-spot relative-value, futures-proxy momentum, FX-rotation, rates/curve-shock, bond-volatility stress, and futures-positioning candidates were registered, SHA256-locked, smoke-tested, and run through the real 9-cell matrix without tuning. Zero produced a full independent Phase 0 first-pass approval. One GLD ETF flow v0 candidate produced PF >= 1.30 in 9/9 cells, but failed trade-count, activity, and concentration gates; broader GLD-flow versions either solved trade count while diluting PF or preserved only one-broker pockets. Both real-yield / breakeven-inflation mix reversal and follow-through expressions failed PF persistence. Official CNY-dollar pressure follow-through solved sample size but failed PF persistence; official CNY-dollar pressure reversion found a sparse Capital.com pocket but failed sample size and cross-broker persistence. Treasury-curve shock follow-through solved sample size but failed PF persistence and cross-broker transfer. Corporate credit-spread shock follow-through also solved sample size but failed PF persistence and cross-broker transfer. Financial-conditions shock follow-through solved sample size but failed PF persistence and cross-broker transfer. GVZ-realized-volatility spread follow-through found all-positive cells but failed PF persistence, activity, and cross-broker threshold persistence. GVZ/VIX volatility-premium follow-through solved sample size but all broker/cost windows were negative. Direct HG/GC copper-gold futures rotation follow-through solved sample size but failed PF persistence and cross-broker transfer; the paired reversal also solved sample size but only reached 1/9 PF cells and failed activity. MOVE/VIX bond-volatility follow-through failed PF persistence, sample-size coverage, and activity. Weekend-gap reversion produced only 33 total cost-cell trades and failed sample-size/activity/PF persistence outright. A new `quarter_round_retest_v0` same-family level candidate passed automated gates, but it is not diversification and remains Gate 9 pending.
...
| 64 | `h1_cny_dollar_pressure_reversion_v0` | Official FRED CNY-dollar pressure reversion | 3/9 | REJECTED_FIRST_PASS: 0/9 trade-count cells |
| 65 | `h1_treasury_curve_shock_followthrough_v0` | FRED Treasury-rate / 2s10s curve shock follow-through | 0/9 | REJECTED_FIRST_PASS |
| 66 | `h1_credit_spread_shock_followthrough_v0` | FRED BAA/AAA corporate credit-spread shock follow-through | 0/9 | REJECTED_FIRST_PASS |
| 67 | `h1_financial_conditions_shock_followthrough_v0` | FRED NFCI/ANFCI financial-conditions shock follow-through | 0/9 | REJECTED_FIRST_PASS |
| 68 | `h1_gvz_realized_vol_spread_followthrough_v0` | FRED GVZ implied-volatility premium versus H1 realized-volatility follow-through | 1/9 | REJECTED_FIRST_PASS |
| 69 | `h1_gvz_vix_vol_premium_followthrough_v0` | FRED GVZ/VIX relative volatility-premium follow-through | 0/9 | REJECTED_FIRST_PASS |
| 70 | `h1_hg_gc_copper_gold_rotation_followthrough_v0` | Yahoo HG=F/GC=F direct copper-gold futures rotation follow-through | 0/9 | REJECTED_FIRST_PASS |
| 71 | `h1_hg_gc_copper_gold_rotation_reversal_v0` | Yahoo HG=F/GC=F direct copper-gold futures rotation reversal | 1/9 | REJECTED_FIRST_PASS |
| 72 | `h1_move_vix_bond_vol_shock_followthrough_v0` | MOVE/VIX bond-volatility shock follow-through | 0/9 | REJECTED_FIRST_PASS |
| 73 | `weekend_gap_reversion_v0` | Weekend-style market-break gap reversion | 0/9 | REJECTED_FIRST_PASS |
