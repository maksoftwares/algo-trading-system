# H1 Breakeven Inflation Shock Reversal v0 Hypothesis

Hypothesis date: 2026-05-30
Hypothesis version: v0
Author / owner: maksoftwares / Codex
Mechanic family: breakeven-inflation shock intraday reversal
...
Expected R-multiple distribution: Many 1R losses, occasional 1.45R reversals when breakeven-inflation shocks and XAU intraday overreaction diverge. Reject if results require changing shock thresholds, reversal confirmation, stop, target, or time stop after first-pass evidence.
...
`h1_breakeven_inflation_shock_reversal_v0` tests whether shifted US breakeven-inflation shocks identify short-term XAU H1 overreaction/reversal opportunities.

Data source:

- FRED `T5YIE`, the 5-year breakeven inflation rate.
- FRED `T10YIE`, the 10-year breakeven inflation rate.
...
2. Compute shifted 10-business-day change in 5-year and 10-year breakevens.
3. Compute shifted 252-business-day z-score of the 5-year breakeven 10-day change.
4. Inflation shock is active when shifted 5-year breakeven change >= +0.08 and shifted 10-year breakeven change >= +0.05, or when shifted 5-year change z-score >= +0.75.
5. Disinflation shock is active when shifted 5-year breakeven change <= -0.08 and shifted 10-year breakeven change <= -0.05, or when shifted 5-year change z-score <= -0.75.
6. Long setup:
   - inflation shock is active
...
Expected PF: at least 1.30 in 7 of 9 matrix cells if breakeven-inflation shocks contain tradable XAU reversal information.
...
The rejected H4 breakeven-inflation candidate tested slow momentum alignment. This v0 tests a different mechanism: inflation-expectation shocks may make XAU intraday price overreact or lag, and a completed H1 reversal candle after that shock may capture mean reversion without relying on support/resistance retests. This is not a level-and-pullback strategy.
...
- the T5YIE/T10YIE sources cannot cover the matrix windows
