...
| D2 - White Reality Check / SPA-style bootstrap | PASS | Post-`m15_inside_bar_breakout_v0` rerun: `breakout_retest` remained the family winner against the 21 non-empty matrix-ledger candidates; White Reality Check p-value 0.0200 and max pairwise SPA p-value 0.0330. |
...
| Non-empty candidate universe | 21 |
...
That audit found 20 rejected/research candidates, 4 with sample-size failures, 20 with multi-cell expectancy failures, and 0 frequency-only failures.
