...
| D2 - White Reality Check / SPA-style bootstrap | PASS | Post-`m5_impulse_continuation_v0` rerun: `breakout_retest` remained the family winner against the 22 non-empty matrix-ledger candidates; White Reality Check p-value 0.0200 and max pairwise SPA p-value 0.0264. |
...
| Non-empty candidate universe | 22 |
...
That audit found 21 rejected/research candidates, 4 with sample-size failures, 21 with multi-cell expectancy failures, and 0 frequency-only failures.
