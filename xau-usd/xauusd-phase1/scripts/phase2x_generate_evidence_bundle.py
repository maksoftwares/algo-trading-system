...
def generate_phase2x_evidence_bundle(
    ...
    report_files = [
        ...
        "PHASE2X_DRY_RUN_PROOF_PORTABLE_TERMINAL.md",
        "PHASE2X_KILL_SWITCH_PROOF_PORTABLE_TERMINAL.md",
        "PHASE2X_OWNER_EXEC_PORTABLE_TERMINAL.md",
        "PHASE2X_OWNER_EXECUTION_STATUS_REPORT.md",
