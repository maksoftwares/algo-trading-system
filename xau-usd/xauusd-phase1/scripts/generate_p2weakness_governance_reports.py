...
def _parity_payload(
    ...
    checks = [
        ...
        _preset_check(owner_template, "owner_template_auth_token_blank", "InpExperimentalAuthorizationToken", ""),
        _preset_check(owner_template, "owner_template_cost_ack_blank", "InpCostSuspensionAcknowledgementToken", ""),
