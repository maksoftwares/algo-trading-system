...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| chart01.chr | `Account3BreakoutPlainExecutor` | `A3_BREAKOUT_PLAIN_V1_PAUSED_20260618` | `true` | `false` | `` | `false` |
| chart02.chr | `Account3BreakoutImprovedExecutor` | `A3_BREAKOUT_IMPROVED_V1_PAUSED_20260618` | `true` | `false` | `` | `false` |
| chart04.chr | `Account3BreakoutTier1CompatExecutor` | `A3_BREAKOUT_TIER1_COMPAT_V1_PAUSED_20260618` | `true` | `false` | `` | `false` |
| chart05.chr | `Account3ProfitLockExitManager` | `A3_PROFIT_LOCK_EXIT_MANAGER_V1_DRYRUN_PAUSED_20260618` | `true` | `` | `false` | `false` |
| chart06.chr | `Account3SoftRetestExecutor` | `A3_SQ_SOFT_RETEST_W15_B45_C60_RCM05_V2_ARMED_20260618_PAUSED_20260618` | `true` | `false` | `` | `false` |
...
| `a3_profile_charts_discovered` | `PASS` | chart_count=6 |
| `dynamic_a3_action_targets_discovered` | `PASS` | chart01.chr,chart02.chr,chart04.chr,chart05.chr,chart06.chr |
...
| `planned_changes_built` | `PASS` | plan_count=5 |
...
| `target_charts_safe_after` | `PASS` | chart01.chr,chart02.chr,chart04.chr,chart05.chr,chart06.chr |
