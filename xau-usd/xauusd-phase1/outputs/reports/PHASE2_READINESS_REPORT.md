...
| Phase 1 summary health | FAIL | Non-pass status fields: log_verification, runtime_health |
| Five trading day soak | PENDING | Progress 0.14%; observed 0.0069 of 5.00 required days. |
| Latest dry-run boundary | PASS | bar_time=2026.05.22 11:10:00; dry_run=true; permission=false; server_time=CLOCK_OK. |
| Would-signal evidence | WARN | No would-signal clusters found yet. |
...
| --- | --- | --- | --- | --- | --- |
| 4 | 2026.05.22 11:10:00 | true | false | CLOCK_OK | 0.14% |
