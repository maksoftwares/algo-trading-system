...
| Five trading day soak | PENDING | Progress 7.08%; observed 0.3542 of 5.00 required days. |
| Latest dry-run boundary | PASS | bar_time=2026.05.21 22:15:00; dry_run=true; permission=false; server_time=CLOCK_OK. |
...
| --- | --- | --- | --- | --- | --- |
| 96 | 2026.05.21 22:15:00 | true | false | CLOCK_OK | 7.08% |
