...
| Fixed-notional reporting | PASS | Found `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase0\outputs\reports\FIXED_NOTIONAL_REPORT.md`. |
| Measured cost model | PENDING | Missing `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase0\outputs\reports\MEASURED_COST_MODEL.md`; required before Phase 2 authorization. |
| Measured-cost revalidation | PENDING | Missing `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase0\outputs\reports\BREAKOUT_RETEST_MEASURED_COST_REVALIDATION.md`; required before Phase 2 authorization. |
...
| Five trading day soak | PENDING | Progress 13.61%; observed 0.6806 of 5.00 required days. |
| Latest dry-run boundary | PASS | bar_time=2026.05.22 06:05:00; dry_run=true; permission=false; server_time=CLOCK_OK. |
| Would-signal evidence | PASS | Rows: 13; clusters: 13. |
...
| --- | --- | --- | --- | --- | --- |
| 190 | 2026.05.22 06:05:00 | true | false | CLOCK_OK | 13.61% |
