...
| --- | --- | --- | --- | --- | --- |
| Active-market 72-hour soak | PENDING | 25.58 | 72.0 | 46.42 | hours |
| Process/code-freeze 96-hour gate | PENDING | 26.66 | 96.0 | 69.34 | hours |
...
| VPS latency evidence | PENDING | After VPS is provisioned, capture ping/traceroute/Test-NetConnection evidence. |
...
| --- | --- |
| decision_rows | 1042 |
| latest_bar | 2026.05.28 13:20:00 |
| dry_run | true |
