...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 1040. |
...
| latest_row_freshness | PASS | Latest row age is 4.2 minute(s); limit 15. |
...
- Latest bar time: 2026.05.28 13:10:00
- Latest local timestamp: 2026.05.28 18:40:00
- Observer transitions: 562

## Latest Row

| Run ID | Broker Time | Bar Time | Risk | Execution | Server Time | BR Stage | BR Direction | Would Signal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 13:10:00 | 2026.05.28 13:10:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | SHORT | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1040 | 50.00 | 50.00 | 75.00 | 180.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1040 | 0.00 | 0.00 | 1.00 | 55165.00 |
...
| phase1-dry-run-v0.7 | 307 | 2026.05.27 10:40:00 | 2026.05.28 13:10:00 |
