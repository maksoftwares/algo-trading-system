...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 1407. |
...
| per_run_bar_cadence | PASS | phase1-dry-run-v0.6: 4 expected market-break gap(s); phase1-dry-run-v0.7: 3 expected market-break gap(s) |
| latest_row_freshness | PASS | Latest row age is 2267.4 minute(s), but local date is a weekend market break; soak time remains paused. |
...
- Latest bar time: 2026.05.29 20:55:00
- Latest local timestamp: 2026.05.30 02:24:58
- Observer transitions: 765

## Latest Row

| Run ID | Broker Time | Bar Time | Risk | Execution | Server Time | BR Stage | BR Direction | Would Signal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.29 20:55:00 | 2026.05.29 20:55:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | SHORT | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1407 | 50.00 | 50.00 | 75.00 | 180.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1407 | 0.00 | 0.00 | 1.00 | 55165.00 |
