...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 1063. |
...
- Latest bar time: 2026.05.28 15:05:00
- Latest local timestamp: 2026.05.28 20:35:00
- Observer transitions: 575

## Latest Row

| Run ID | Broker Time | Bar Time | Risk | Execution | Server Time | BR Stage | BR Direction | Would Signal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 15:05:00 | 2026.05.28 15:05:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | LONG | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1063 | 50.00 | 50.00 | 75.00 | 180.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1063 | 0.00 | 0.00 | 1.00 | 55165.00 |
...
| phase1-dry-run-v0.7 | 330 | 2026.05.27 10:40:00 | 2026.05.28 15:05:00 |
