...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 182. |
...
| latest_row_freshness | PASS | Latest row age is 3.9 minute(s); limit 15. |
...
- Latest bar time: 2026.05.22 05:25:00
- Latest local timestamp: 2026.05.22 09:24:57
- Observer transitions: 112

## Latest Row

| Run ID | Broker Time | Bar Time | Risk | Execution | Server Time | BR Stage | BR Direction | Would Signal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.5 | 2026.05.22 05:25:00 | 2026.05.22 05:25:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | LONG | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 182 | 50.00 | 50.00 | 75.00 | 95.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 182 | 0.00 | 0.00 | 0.00 | 1.00 |
