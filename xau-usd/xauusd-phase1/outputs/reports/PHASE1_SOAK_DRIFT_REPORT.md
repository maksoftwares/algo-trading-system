...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 1045. |
...
| latest_row_freshness | PASS | Latest row age is 4.5 minute(s); limit 15. |
...
- Latest bar time: 2026.05.28 13:35:00
- Latest local timestamp: 2026.05.28 19:05:00
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 13:35:00 | 2026.05.28 13:35:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | SHORT | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1045 | 50.00 | 50.00 | 75.00 | 180.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1045 | 0.00 | 0.00 | 1.00 | 55165.00 |
...
| phase1-dry-run-v0.7 | 312 | 2026.05.27 10:40:00 | 2026.05.28 13:35:00 |
