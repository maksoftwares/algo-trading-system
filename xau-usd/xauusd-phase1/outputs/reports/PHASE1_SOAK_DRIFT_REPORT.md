...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 799. |
...
- Latest bar time: 2026.05.27 16:05:00
- Latest local timestamp: 2026.05.27 21:34:59
- Observer transitions: 429

## Latest Row

| Run ID | Broker Time | Bar Time | Risk | Execution | Server Time | BR Stage | BR Direction | Would Signal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.27 16:05:00 | 2026.05.27 16:05:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | LONG | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 799 | 50.00 | 50.00 | 75.00 | 180.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 799 | 0.00 | 0.00 | 1.00 | 55165.00 |
