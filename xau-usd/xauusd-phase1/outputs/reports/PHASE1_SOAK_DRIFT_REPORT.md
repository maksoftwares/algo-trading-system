...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 197. |
...
| latest_row_freshness | PASS | Latest row age is 2.0 minute(s); limit 15. |
...
- Latest bar time: 2026.05.22 06:40:00
- Latest local timestamp: 2026.05.22 10:39:57
- Observer transitions: 122

## Latest Row

| Run ID | Broker Time | Bar Time | Risk | Execution | Server Time | BR Stage | BR Direction | Would Signal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.5 | 2026.05.22 06:40:00 | 2026.05.22 06:40:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | SHORT | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 197 | 50.00 | 50.00 | 75.00 | 95.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 197 | 0.00 | 0.00 | 0.00 | 1.00 |
...
| --- | --- | --- | --- |
| phase1-dry-run-v0.5 | 193 | 2026.05.21 13:45:00 | 2026.05.22 06:40:00 |
