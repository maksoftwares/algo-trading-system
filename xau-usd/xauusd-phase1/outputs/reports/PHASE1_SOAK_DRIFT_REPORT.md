...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 108. |
...
- Latest bar time: 2026.05.21 23:15:00
- Latest local timestamp: 2026.05.22 03:14:58
- Observer transitions: 60

## Latest Row

| Run ID | Broker Time | Bar Time | Risk | Execution | Server Time | BR Stage | BR Direction | Would Signal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.5 | 2026.05.21 23:15:00 | 2026.05.21 23:15:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | LONG | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 108 | 50.00 | 50.00 | 75.00 | 95.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 108 | 0.00 | 0.00 | 1.00 | 1.00 |
...
| --- | --- | --- | --- |
| phase1-dry-run-v0.5 | 104 | 2026.05.21 13:45:00 | 2026.05.21 23:15:00 |
