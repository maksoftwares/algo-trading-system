...
| --- | --- | --- |
| decision_rows | PASS | Rows available for soak analysis: 1819. |
...
| latest_row_freshness | PASS | Latest row age is 4.7 minute(s); limit 240. |
...
- Latest bar time: 2026.06.02 10:20:00
- Latest local timestamp: 2026.06.02 14:19:57
- Observer transitions: 993

## Latest Row

| Run ID | Broker Time | Bar Time | Risk | Execution | Server Time | BR Stage | BR Direction | Would Signal |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.06.02 10:20:01 | 2026.06.02 10:20:00 | NORMAL | EXECUTION_OK | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST | LONG | false |

## Spread Points

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1819 | 50.00 | 50.00 | 75.00 | 180.00 |

## Stale Seconds

| count | min | median | p95 | max |
| --- | --- | --- | --- | --- |
| 1819 | 0.00 | 0.00 | 1.00 | 55165.00 |
