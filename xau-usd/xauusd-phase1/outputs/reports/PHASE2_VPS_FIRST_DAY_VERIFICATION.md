...
| --- | --- | --- |
| repo_commit_hash | PASS | Repository commit hash captured: ad4f25f8912d1e8cf1df018ff62c46569cce0f6b. |
...
| latest_decision_log_row | PASS | `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` has 1050 row(s); latest row captured. |
...
| phase1_status_summary | PASS | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE1_STATUS_SUMMARY.json` latest bar 2026.05.28 14:00:00 keeps dry_run=true and trade_permission=false. |
