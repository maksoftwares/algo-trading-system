...
| --- | --- | --- |
| repo_commit_hash | PASS | Repository commit hash captured: 6d2cb4ecc34a11ba1271e516fcce1cf6bdefd79f. |
...
| phase1_status_summary | PASS | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE1_STATUS_SUMMARY.json` latest bar 2026.06.02 14:05:00 keeps dry_run=true and trade_permission=false. |
| phase2_readiness_report | PASS | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE2_READINESS_REPORT.md` exists; current status is FAIL. |
| vps_latency_report | PASS | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE2_VPS_LATENCY_REPORT.md` status is PASS and includes local baseline comparison. |
| selected_vps_consistency | PENDING | Manual VPS evidence is not ready for selected-provider comparison: vps_ntp_sync.txt not owner-verified; vps_backup_config.txt not owner-verified; vps_rdp_recovery.txt not owner-verified; vps_periodic_task.txt not owner-verified. |
