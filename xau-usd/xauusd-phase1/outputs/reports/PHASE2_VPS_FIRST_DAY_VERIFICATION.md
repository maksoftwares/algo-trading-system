...
| --- | --- | --- |
| repo_commit_hash | PASS | Repository commit hash captured: f8d0122dfef0eb85a65067b26c9d240df21dd565. |
...
| latest_decision_log_row | PASS | `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` has 1062 row(s); latest row captured. |
...
| phase1_status_summary | PASS | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE1_STATUS_SUMMARY.json` latest bar 2026.05.28 15:00:00 keeps dry_run=true and trade_permission=false. |
