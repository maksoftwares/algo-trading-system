...
| latest_decision_log_row | PASS | `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` has 1051 row(s); latest row captured. |
...
| phase1_status_summary | PASS | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE1_STATUS_SUMMARY.json` latest bar 2026.05.28 14:05:00 keeps dry_run=true and trade_permission=false. |
