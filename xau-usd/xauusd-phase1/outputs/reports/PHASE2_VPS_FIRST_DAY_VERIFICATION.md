...
| --- | --- | --- |
| repo_commit_hash | PASS | Repository commit hash captured: 7c6cecd4e446b54794bbd37b52c5a28902737037. |
...
| latest_decision_log_row | PASS | `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` has 1060 row(s); latest row captured. |
...
| phase1_status_summary | PASS | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE1_STATUS_SUMMARY.json` latest bar 2026.05.28 14:50:00 keeps dry_run=true and trade_permission=false. |
...
| periodic_scheduler_evidence | PENDING | Missing or empty `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\vps_periodic_task.txt`. |
