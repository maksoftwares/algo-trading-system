...
| --- | --- | --- |
| repo_commit_hash | PASS | Repository commit hash captured: 6a20cd8f3a823c906d4954d45bae3665fb88612a. |
...
| latest_decision_log_row | PASS | `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` has 1056 row(s); latest row captured. |
...
| phase1_status_summary | PASS | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE1_STATUS_SUMMARY.json` latest bar 2026.05.28 14:30:00 keeps dry_run=true and trade_permission=false. |
