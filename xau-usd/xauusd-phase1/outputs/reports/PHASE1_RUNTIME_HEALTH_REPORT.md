...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (775149 bytes). |
...
| decision_rows | PASS | Decision rows: 838. |
| latest_freshness | PASS | Latest row age is 2.3 minute(s); limit 15. |
...
| unique_bar_gaps | PASS | Only expected market-break gaps found: 4. |
...
- Latest unique M5 bar: 2026.05.27 19:20:00
- Larger-than-M5 gaps: 0
- Expected market-break gaps: 4

## Latest Row

| Run ID | Broker Time | Local Time | Bar Time | Dry Run | Permission | Server Time | BR Stage |
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.27 19:20:01 | 2026.05.28 00:49:59 | 2026.05.27 19:20:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
...
| phase1-dry-run-v0.7 | 105 | 2026.05.27 10:40:00 | 2026.05.27 19:20:00 |
