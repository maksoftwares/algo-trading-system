...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (983127 bytes). |
...
| decision_rows | PASS | Decision rows: 1060. |
...
- Latest unique M5 bar: 2026.05.28 14:50:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 14:50:00 | 2026.05.28 20:20:00 | 2026.05.28 14:50:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
