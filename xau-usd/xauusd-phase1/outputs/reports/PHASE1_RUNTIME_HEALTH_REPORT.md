...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (1035453 bytes). |
...
| decision_rows | PASS | Decision rows: 1116. |
| latest_freshness | PASS | Latest row age is 4.8 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.05.28 19:30:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 19:30:00 | 2026.05.29 00:59:59 | 2026.05.28 19:30:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
