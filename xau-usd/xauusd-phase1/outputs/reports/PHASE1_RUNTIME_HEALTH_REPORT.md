...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (969066 bytes). |
...
| decision_rows | PASS | Decision rows: 1045. |
| latest_freshness | PASS | Latest row age is 4.5 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.05.28 13:35:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 13:35:00 | 2026.05.28 19:05:00 | 2026.05.28 13:35:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
