...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (980313 bytes). |
...
| decision_rows | PASS | Decision rows: 1057. |
| latest_freshness | PASS | Latest row age is 1.6 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.05.28 14:35:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 14:35:00 | 2026.05.28 20:05:00 | 2026.05.28 14:35:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
