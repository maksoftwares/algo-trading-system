...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (692485 bytes). |
...
| latest_freshness | PASS | Latest row age is 3.4 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.05.27 12:00:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.27 12:00:00 | 2026.05.27 17:30:00 | 2026.05.27 12:00:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
