...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (794841 bytes). |
...
| latest_freshness | PASS | Latest row age is 0.2 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.05.27 22:05:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.27 22:05:00 | 2026.05.28 03:34:58 | 2026.05.27 22:05:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
