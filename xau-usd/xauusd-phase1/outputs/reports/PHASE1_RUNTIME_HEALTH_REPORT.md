...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (979373 bytes). |
...
| decision_rows | PASS | Decision rows: 1056. |
| latest_freshness | PASS | Latest row age is 2.4 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.05.28 14:30:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 14:30:00 | 2026.05.28 20:00:00 | 2026.05.28 14:30:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
