...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (991546 bytes). |
...
| decision_rows | PASS | Decision rows: 1069. |
| latest_freshness | PASS | Latest row age is 2.9 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.05.28 15:35:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 15:35:00 | 2026.05.28 21:04:59 | 2026.05.28 15:35:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
