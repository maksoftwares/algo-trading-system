...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (1735509 bytes). |
...
| decision_rows | PASS | Decision rows: 1864. |
| latest_freshness | PASS | Latest row age is 3.7 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.06.02 14:05:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.06.02 14:05:00 | 2026.06.02 18:05:01 | 2026.06.02 14:05:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
...
| phase1-dry-run-v0.7 | 1131 | 2026.05.27 10:40:00 | 2026.06.02 14:05:00 |
