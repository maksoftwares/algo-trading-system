...
| --- | --- | --- |
| decision_log | PASS | Found `C:\MT5PortableGoldMission\MQL5\Files\decision_log.csv` (970937 bytes). |
...
| decision_rows | PASS | Decision rows: 1047. |
| latest_freshness | PASS | Latest row age is 3.2 minute(s); limit 15. |
...
- Latest unique M5 bar: 2026.05.28 13:45:00
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| phase1-dry-run-v0.7 | 2026.05.28 13:45:00 | 2026.05.28 19:15:00 | 2026.05.28 13:45:00 | true | false | CLOCK_OK | WAIT_LEVEL_BREAK_RETEST |
