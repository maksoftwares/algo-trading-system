...
| Runtime freshness | WARN | Latest row age is 438.1 minute(s); limit 15. |
...
| Process/code-freeze 96-hour gate | PENDING | Process uptime streak: 34.05h; code-freeze hours: 0.00h; required: 96h; marker: missing; marker path: `C:\MT5PortableGoldMission\MQL5\Files\phase1_code_freeze_started_at.txt`. |
