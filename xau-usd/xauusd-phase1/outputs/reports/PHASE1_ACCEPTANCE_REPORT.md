...
| Runtime freshness | PASS | Latest row age is 2.0 minute(s); limit 15. |
| Latest runtime row | PASS | run_id=phase1-dry-run-v0.5; bar_time=2026.05.22 06:40:00; risk=NORMAL; server_time=CLOCK_OK; observer=WAIT_LEVEL_BREAK_RETEST/SHORT; would_signal=false |
| Five trading day soak | PENDING | Observed unique-bar span: 0.70 calendar day(s), from 2026-05-21 13:45:00 to 2026-05-22 06:40:00. |
