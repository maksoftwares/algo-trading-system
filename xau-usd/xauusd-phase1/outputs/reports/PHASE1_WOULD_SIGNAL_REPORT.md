...
| --- | --- | --- |
| would_signal_rows | PASS | Would-signal rows observed: 148. |
| would_signal_clusters | PASS | Setup clusters observed: 148. |
...
| Value | Count |
| --- | --- |
| latest_swing_high | 64 |
| latest_swing_low | 65 |
| previous_daily_high | 4 |
