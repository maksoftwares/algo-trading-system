...
| Older demo experimental family | Demo-only experimental / non-canonical | `920000-920999`; active BTC breakout experiment `920105` | Same-family duplicate suppression only; not canonical Phase 2. BTCUSD is owner-requested experimental evidence, not an approved Phase 0 edge. |
