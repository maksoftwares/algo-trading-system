...
enum Phase1ExpertLifecycleState
{
   ...
   PHASE1_EXPERT_COST_SUSPENDED_CANONICAL_PENDING_SANITY_CHECK = 7,
   PHASE1_EXPERT_COST_SUSPENDED_CANONICAL = 8,
   PHASE1_EXPERT_COST_REVALIDATION_REGENERATED_PENDING_REVIEW = 9
};
...
string Phase1ExpertLifecycleText(const Phase1ExpertLifecycleState state)
{
   ...
   if(state == PHASE1_EXPERT_COST_SUSPENDED_CANONICAL_PENDING_SANITY_CHECK)
      return "COST_SUSPENDED_CANONICAL_PENDING_SANITY_CHECK";
   if(state == PHASE1_EXPERT_COST_SUSPENDED_CANONICAL)
      return "COST_SUSPENDED_CANONICAL";
   if(state == PHASE1_EXPERT_COST_REVALIDATION_REGENERATED_PENDING_REVIEW)
      return "COST_REVALIDATION_REGENERATED_PENDING_REVIEW";
   return "DISABLED";
}
