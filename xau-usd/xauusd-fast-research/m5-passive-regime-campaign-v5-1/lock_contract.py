...
from clock import load_config, sha256_file  # noqa: E402
...
PASSIVE = load_module("m5_passive_v51_lock_base", V5_ROOT / "src" / "passive.py")
R2 = load_module(
    "m5_passive_v51_lock_r2",
...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/m5_passive_regime_campaign_v5_1.json",
    "src/__init__.py",
    "src/clock.py",
    "lock_contract.py",
    "run_screen.py",
...
DEPENDENCIES = (
    ...
    "../m5-passive-regime-campaign-v5/run_screen.py",
    "../m5-passive-regime-campaign-v5/outputs/M5_PASSIVE_REGIME_V5_CONTRACT_LOCK.json",
    "../m5-passive-regime-campaign-v5/outputs/M5_PASSIVE_REGIME_V5_MANIFEST.csv",
    "../m5-passive-regime-campaign-v5/outputs/M5_PASSIVE_REGIME_V5_INVALIDATION.json",
...
def build_lock(config: dict[str, Any]) -> dict[str, Any]:
    ...
    manifest = PASSIVE.generate_manifest(config["selection"])
    ...
    if sha256_file(manifest_path) != expected_manifest_hash:
        raise ValueError("V5.1 manifest differs from V5")
    ...
    payload: dict[str, Any] = {
        "schema_version": "xauusd_m5_passive_regime_campaign_v5_1_contract",
