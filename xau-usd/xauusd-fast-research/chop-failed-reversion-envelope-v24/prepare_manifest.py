...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V24 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_failed_reversion_v24_manifest_evidence",
