...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_failed_reversion_envelope_v24.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
DEPENDENCIES = (
    ...
    "../chop-m15-stationarity-antisignal-v22/outputs/CHOP_M15_STATIONARITY_ANTISIGNAL_V22_RESULT.json",
    "../chop-m15-stationarity-antisignal-v22/outputs/CHOP_M15_STATIONARITY_ANTISIGNAL_V22_METRICS.csv",
    "../chop-failed-reversion-continuation-v23/outputs/CHOP_FAILED_REVERSION_CONTINUATION_V23_RESULT.json",
    "../chop-failed-reversion-continuation-v23/outputs/CHOP_FAILED_REVERSION_CONTINUATION_V23_METRICS.csv",
)
...
def main() -> int:
    config = json.loads(
        (ROOT / "config" / "chop_failed_reversion_envelope_v24.json").read_text(
            encoding="utf-8"
        )
    )
    ...
    if lock_path.exists():
        raise FileExistsError("V24 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_failed_reversion_v24_contract",
        ...
        "v22_stationarity_antisignal_outcomes_exposed": True,
        "v23_failed_reversion_outcomes_exposed": True,
