...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_exit_hazard_antisignal_v19.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
DEPENDENCIES = (
    ...
    "../chop-exit-hazard-campaign-v18/src/campaign.py",
    "../chop-exit-hazard-campaign-v18/config/chop_exit_hazard_campaign_v18.json",
    "../chop-exit-hazard-campaign-v18/outputs/CHOP_EXIT_HAZARD_V18_CONTRACT_LOCK.json",
    "../chop-exit-hazard-campaign-v18/outputs/CHOP_EXIT_HAZARD_V18_MANIFEST.csv",
    "../chop-exit-hazard-campaign-v18/outputs/CHOP_EXIT_HAZARD_V18_RESULT.json",
    "../chop-exit-hazard-campaign-v18/outputs/CHOP_EXIT_HAZARD_V18_METRICS.csv",
)
...
def main() -> int:
    ...
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_exit_hazard_antisignal_v19_contract",
        ...
        "v18_outcomes_exposed_before_exact_direction_inverse": True,
        "source_signals_parameters_and_geometries_frozen": True,
