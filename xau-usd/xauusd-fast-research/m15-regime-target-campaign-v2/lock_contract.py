...
from correction import load_config  # noqa: E402
...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/m15_regime_target_campaign_v2.json",
    "src/__init__.py",
    "src/correction.py",
    "lock_contract.py",
    "run_screen.py",
...
DEPENDENCIES = (
    ...
    "../m15-regime-target-campaign-v1/outputs/M15_REGIME_TARGET_CAMPAIGN_V1_INVALIDATION.json",
...
def build_lock(config: dict[str, Any]) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        "schema_version": "xauusd_m15_regime_target_campaign_v2_contract",
        ...
        "v1_definitions_unchanged": True,
        "v1_quantitative_inference_permitted": False,
