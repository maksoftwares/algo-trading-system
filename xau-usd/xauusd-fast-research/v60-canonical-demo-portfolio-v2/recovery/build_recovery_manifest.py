...
CRITICAL_FILES = [
    ...
    "xau-usd/xauusd-fast-research/v60-canonical-demo-portfolio-v2/build_deployment_parity.py",
    ...
    "xau-usd/xauusd-fast-research/v60-canonical-demo-portfolio-v2/tests/test_addon_parity.py",
    "xau-usd/xauusd-fast-research/v60-canonical-demo-portfolio-v2/tests/test_portfolio.py",
    ...
    "xau-usd/xauusd-fast-research/codex-v60-tick-runtime-replay-v1/tests/test_replay.py",
    ...
    "xau-usd/xauusd-phase1/tests/test_account_daily_guardian_scope.py",
