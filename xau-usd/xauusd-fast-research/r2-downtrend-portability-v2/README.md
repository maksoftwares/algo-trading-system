...
V1 was invalidated before outcomes because a boundary decision equaled the
data end. V2 adds the end-exclusive boundary check and changes nothing else.
