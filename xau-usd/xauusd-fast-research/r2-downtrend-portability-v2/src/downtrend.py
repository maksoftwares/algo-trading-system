...
def generate_all_candidates(
    ...
    inside = result["decision_time"].ge(start) & result["decision_time"].lt(end)
    boundary_removed = int((~inside).sum())
    ...
    result.attrs["boundary_candidates_removed"] = boundary_removed
    return result
