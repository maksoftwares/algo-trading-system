...
V2 supersedes pre-outcome-invalidated V1. It makes no strategy, parameter,
window, cost, or gate change. It only drops candidate decisions outside the
sealed half-open interval `2010-01-01 <= decision < 2026-07-01`.
