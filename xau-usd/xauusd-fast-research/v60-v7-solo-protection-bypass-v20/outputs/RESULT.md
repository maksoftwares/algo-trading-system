# V60 V7-Only Profit-Protection Bypass V20 Result
...
| Net P/L | $3603.57 | $3681.34 | $3720.84 | $+39.50 |
| Profit factor | 1.7107 | 1.7377 | 1.7347 | -0.0030 |
| Closed drawdown | $223.28 | $217.46 | $218.71 | $+1.25 |
| Equity drawdown | $238.28 | $238.28 | $239.53 | $+1.25 |

## Mechanism exercise

- V7 solo-bypass trade IDs observed: `315`.
- V7-only five-second bypass cycles: `809334`.
- V7/non-V7 mixed-basket cycles delegated unchanged: `145412`.
