...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_transition_mechanisms_v2.json",
    "src/__init__.py",
    "src/campaign.py",
    "lock_contract.py",
    "run_screen.py",
...
def build_lock(config: dict[str, Any]) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_transition_mechanisms_v2_contract",
...
def main() -> int:
    config_path = ROOT / "config" / "chop_transition_mechanisms_v2.json"
