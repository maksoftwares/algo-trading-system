...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V17 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_microstructure_antisignal_v17_manifest_evidence",
