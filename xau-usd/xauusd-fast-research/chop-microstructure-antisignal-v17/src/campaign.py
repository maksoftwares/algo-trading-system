...
V16_MECHANICS = {
    "CHOP_FLOW_CONTINUATION_REVERSE": "CHOP_FLOW_CONTINUATION",
    "CHOP_FLOW_EXHAUSTION_REVERSE": "CHOP_FLOW_EXHAUSTION",
    "CHOP_BOOK_ABSORPTION_REVERSE": "CHOP_BOOK_ABSORPTION",
    "CHOP_LIQUIDITY_SHOCK_REVERSION_REVERSE": "CHOP_LIQUIDITY_SHOCK_REVERSION",
    "CHOP_POST_SHOCK_NORMALIZATION_REVERSE": "CHOP_POST_SHOCK_NORMALIZATION",
}
SOURCE_MECHANICS = {
    "CHOP_FLOW_CONTINUATION_REVERSE": "FLOW_CONTINUATION",
    "CHOP_FLOW_EXHAUSTION_REVERSE": "FLOW_EXHAUSTION",
    "CHOP_BOOK_ABSORPTION_REVERSE": "BOOK_ABSORPTION",
    "CHOP_LIQUIDITY_SHOCK_REVERSION_REVERSE": "LIQUIDITY_SHOCK_REVERSION",
    "CHOP_POST_SHOCK_NORMALIZATION_REVERSE": "POST_SHOCK_NORMALIZATION",
}
...
def generate_manifest(frame: pd.DataFrame, config: Mapping[str, Any]) -> pd.DataFrame:
    ...
    for mechanic in selection["mechanics"]:
        source_mechanic = V16_MECHANICS[str(mechanic)]
