...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_microstructure_antisignal_v17.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
DEPENDENCIES = (
    ...
    "../m5-microstructure-mechanics-v1/outputs/M5_MICROSTRUCTURE_RESULT.json",
    "../m5-microstructure-mechanics-v1/outputs/M5_MICROSTRUCTURE_DISCOVERY_METRICS.csv",
    "../chop-antisignal-campaign-v15/outputs/CHOP_ANTISIGNAL_V15_POSTHOC_SIDE_SUMMARY.json",
    "../chop-microstructure-state-campaign-v16/outputs/CHOP_MICROSTRUCTURE_STATE_V16_RESULT.json",
    "../chop-microstructure-state-campaign-v16/outputs/CHOP_MICROSTRUCTURE_STATE_V16_METRICS.csv",
)
...
def main() -> int:
    config = json.loads(
        (ROOT / "config" / "chop_microstructure_antisignal_v17.json").read_text(
            encoding="utf-8"
        )
    )
    ...
    if lock_path.exists():
        raise FileExistsError("V17 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_microstructure_antisignal_v17_contract",
        ...
        "prior_m5_and_chop_outcomes_exposed": True,
        "v16_outcomes_exposed": True,
        "antisignal_hypothesis_derived_from_v16": True,
