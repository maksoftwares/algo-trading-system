...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V16 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_microstructure_state_v16_manifest_evidence",
