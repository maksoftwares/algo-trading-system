...
from antisignal import generate_manifest, load_config  # noqa: E402
...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/m15_regime_antisignal_campaign_v3.json",
    "src/__init__.py",
    "src/antisignal.py",
    "lock_contract.py",
    "run_screen.py",
...
DEPENDENCIES = (
    ...
    "../m15-regime-target-campaign-v2/outputs/M15_REGIME_TARGET_CAMPAIGN_V2_RESULT.json",
    "../m15-regime-target-campaign-v2/outputs/M15_REGIME_TARGET_CAMPAIGN_V2_METRICS.csv",
...
def build_lock(config: dict[str, Any]) -> dict[str, Any]:
    ...
    manifest = generate_manifest(config["selection"])
    ...
    payload: dict[str, Any] = {
        "schema_version": "xauusd_m15_regime_antisignal_campaign_v3_contract",
        ...
        "designed_after_m15_target_v2_outcomes": True,
