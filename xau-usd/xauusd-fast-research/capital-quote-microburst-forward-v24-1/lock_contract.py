...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/capital_quote_microburst_forward_v24_1.json",
    "src/__init__.py",
    "src/microburst.py",
...
def main() -> int:
    ...
    if lock_path.exists():
        raise FileExistsError("V24.1 contract already exists")
    ...
    contract = {
        "schema_version": "xauusd_v24_1_contract_lock",
        "structural_predecessor_contract_sha256": "046a3015486c212e0e2e8f832a2e53413f77dc2d364b6f2e08ca6901745ec640",
        "only_authorized_prelock_change": "STABLE_EMPTY_CANDIDATE_SCHEMA",
