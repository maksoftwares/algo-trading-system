...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_m15_stationarity_antisignal_v22.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
DEPENDENCIES = (
    ...
    "../chop-m15-stationarity-campaign-v21/src/campaign.py",
    "../chop-m15-stationarity-campaign-v21/outputs/CHOP_M15_STATIONARITY_V21_MANIFEST.csv",
    "../chop-m15-stationarity-campaign-v21/outputs/CHOP_M15_STATIONARITY_V21_MANIFEST_EVIDENCE.json",
    "../chop-m15-stationarity-campaign-v21/outputs/CHOP_M15_STATIONARITY_V21_RESULT.json",
    "../chop-m15-stationarity-campaign-v21/outputs/CHOP_M15_STATIONARITY_V21_METRICS.csv",
)
...
def main() -> int:
    ...
    if lock_path.exists():
        raise FileExistsError("V22 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_m15_stationarity_v22_contract",
        ...
        "v21_stationarity_reversion_outcomes_exposed": True,
        "source_pair_is_locked": True,
