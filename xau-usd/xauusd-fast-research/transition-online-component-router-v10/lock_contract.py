...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/transition_online_component_router_v10.json",
    "src/__init__.py",
    "src/router.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
def main() -> int:
    ...
    if lock_path.exists():
        raise FileExistsError("V10 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_transition_online_router_v10_contract",
