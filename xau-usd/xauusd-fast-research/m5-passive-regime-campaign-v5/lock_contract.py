...
from passive import generate_manifest, load_config  # noqa: E402
...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/m5_passive_regime_campaign_v5.json",
    "src/__init__.py",
    "src/passive.py",
    "lock_contract.py",
    "run_screen.py",
...
DEPENDENCIES = (
    ...
    "../m15-regime-clock-campaign-v4/outputs/M15_REGIME_CLOCK_V4_RESULT.json",
    "../chop-v1/outputs/CHOP_FAST_DISCOVERY_RESULT.json",
...
def build_lock(config: dict[str, Any]) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        "schema_version": "xauusd_m5_passive_regime_campaign_v5_contract",
        ...
        "designed_after_clock_v4_outcomes": True,
