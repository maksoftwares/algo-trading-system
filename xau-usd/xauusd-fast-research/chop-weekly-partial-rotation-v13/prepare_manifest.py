...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V13 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_weekly_partial_v13_manifest_evidence",
