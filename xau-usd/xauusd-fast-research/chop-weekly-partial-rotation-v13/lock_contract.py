...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_weekly_partial_rotation_v13.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
def main() -> int:
    ...
    if lock_path.exists():
        raise FileExistsError("V13 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_weekly_partial_v13_contract",
