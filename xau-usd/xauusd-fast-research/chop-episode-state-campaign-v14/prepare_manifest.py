...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V14 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_episode_state_v14_manifest_evidence",
