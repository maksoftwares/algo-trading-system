...
def parameter_space(mechanic: str, config: Mapping[str, Any]) -> list[dict[str, Any]]:
    ...
    if mechanic == "CHOP_MATURE_EPISODE_EDGE_REENTRY":
    ...
    if mechanic == "CHOP_MATURE_EPISODE_EDGE_BOUNCE":
        return _bounded_space(
            age_min=[8, 16, 32, 64],
    ...
    if mechanic == "CHOP_FRESH_ANCESTRY_CONTINUATION":
        return _space(
            age_max=[8, 16, 32, 64],
    ...
    if mechanic == "CHOP_FRESH_ANCESTRY_REVERSAL":
        return _space(
            age_max=[8, 16, 32, 64],
            ancestry_max_bars=[128, 256, 512, 1024, 2048],
    ...
    if mechanic == "CHOP_MATURE_EPISODE_BREAKOUT":
        return _bounded_space(
            age_min=[8, 16, 32, 64],
...
def signal_mask_direction(
    ...
    elif mechanic == "CHOP_MATURE_EPISODE_EDGE_BOUNCE":
    ...
    elif mechanic == "CHOP_FRESH_ANCESTRY_CONTINUATION":
    ...
    elif mechanic == "CHOP_FRESH_ANCESTRY_REVERSAL":
        direction = -frame["ancestry_direction"].astype(int)
        momentum = frame[
    ...
    elif mechanic == "CHOP_MATURE_EPISODE_BREAKOUT":
        up = close.gt(
