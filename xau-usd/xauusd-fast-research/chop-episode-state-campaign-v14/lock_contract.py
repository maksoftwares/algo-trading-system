...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_episode_state_campaign_v14.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
def main() -> int:
    ...
    if lock_path.exists():
        raise FileExistsError("V14 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_episode_state_v14_contract",
