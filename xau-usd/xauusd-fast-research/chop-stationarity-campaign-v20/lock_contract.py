...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_stationarity_campaign_v20.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
DEPENDENCIES = (
    ...
    "../chop-exit-hazard-antisignal-v19/outputs/CHOP_EXIT_HAZARD_ANTISIGNAL_V19_RESULT.json",
    "../intraday-strategy-campaign-v2/outputs/INTRADAY_STRATEGY_SCREEN_RESULT.json",
...
def main() -> int:
    config = json.loads(
        (ROOT / "config" / "chop_stationarity_campaign_v20.json").read_text(
            encoding="utf-8"
        )
    )
    ...
    if lock_path.exists():
        raise FileExistsError("V20 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_stationarity_v20_contract",
        ...
        "prior_chop_reversion_exit_and_router_outcomes_exposed": True,
