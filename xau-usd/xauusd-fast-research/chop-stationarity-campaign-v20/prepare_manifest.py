...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V20 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_stationarity_v20_manifest_evidence",
        ...
        "stationarity_feature_rows": int(frame["z_48"].notna().sum()),
