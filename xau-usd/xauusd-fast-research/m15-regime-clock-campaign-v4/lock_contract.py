...
from seasonality import generate_manifest, load_config  # noqa: E402
...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/m15_regime_clock_campaign_v4.json",
    "src/__init__.py",
    "src/seasonality.py",
    "lock_contract.py",
    "run_screen.py",
...
DEPENDENCIES = (
    ...
    "../m15-regime-antisignal-campaign-v3/outputs/M15_REGIME_ANTISIGNAL_V3_RESULT.json",
    "../calendar-session-specialists-v1/outputs/CALENDAR_SESSION_SPECIALISTS_RESULT.json",
...
def build_lock(config: dict[str, Any]) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        "schema_version": "xauusd_m15_regime_clock_campaign_v4_contract",
        ...
        "designed_after_antisignal_v3_outcomes": True,
