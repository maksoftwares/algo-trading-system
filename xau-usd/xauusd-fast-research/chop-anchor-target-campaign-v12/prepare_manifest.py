...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V12 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_anchor_target_v12_manifest_evidence",
