...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_antisignal_campaign_v15.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
DEPENDENCIES = (
    ...
    "../chop-episode-state-campaign-v14/outputs/CHOP_EPISODE_STATE_V14_RESULT.json",
    "../chop-episode-state-campaign-v14/outputs/CHOP_EPISODE_STATE_V14_METRICS.csv",
)
...
def main() -> int:
    ...
    if lock_path.exists():
        raise FileExistsError("V15 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_antisignal_v15_contract",
        ...
        "v14_outcomes_exposed": True,
        "antisignal_hypothesis_derived_from_v14": True,
