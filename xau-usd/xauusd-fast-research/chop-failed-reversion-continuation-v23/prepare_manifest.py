...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V23 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_failed_reversion_v23_manifest_evidence",
        ...
        "failed_reversion_feature_rows": int(frame["z_delta_192"].notna().sum()),
