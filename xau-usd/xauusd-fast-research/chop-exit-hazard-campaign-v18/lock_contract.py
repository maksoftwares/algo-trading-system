...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_exit_hazard_campaign_v18.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
DEPENDENCIES = (
    ...
    "../chop-microstructure-antisignal-v17/outputs/CHOP_MICROSTRUCTURE_ANTISIGNAL_V17_RESULT.json",
    "../walkforward-state-action-router-v1/outputs/WALKFORWARD_STATE_ACTION_ROUTER_V1_RESULT.json",
)
...
def main() -> int:
    config = json.loads(
        (ROOT / "config" / "chop_exit_hazard_campaign_v18.json").read_text(
            encoding="utf-8"
        )
    )
    ...
    if lock_path.exists():
        raise FileExistsError("V18 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_exit_hazard_v18_contract",
        ...
        "prior_m5_chop_and_router_outcomes_exposed": True,
