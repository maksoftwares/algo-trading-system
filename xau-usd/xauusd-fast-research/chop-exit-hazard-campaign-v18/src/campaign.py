...
SOURCE_MECHANICS = {
    "CHOP_ADX_ER_EXIT_PRESSURE": "ADX_ER_EXIT_PRESSURE",
    "CHOP_SLOPE_INFLECTION": "SLOPE_INFLECTION",
    "CHOP_RANGE_EDGE_PRESSURE": "RANGE_EDGE_PRESSURE",
    "CHOP_VOLATILITY_LIFT": "VOLATILITY_LIFT",
    "CHOP_BOUNDARY_CONFLUENCE": "BOUNDARY_CONFLUENCE",
}
