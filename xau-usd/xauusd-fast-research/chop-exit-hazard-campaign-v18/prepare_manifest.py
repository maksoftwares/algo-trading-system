...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V18 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_exit_hazard_v18_manifest_evidence",
