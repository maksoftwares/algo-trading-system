...
def main() -> int:
    ...
    if manifest_path.exists() or evidence_path.exists():
        raise FileExistsError("V21 manifest preflight already exists")
    ...
    evidence = {
        "schema_version": "xauusd_chop_m15_stationarity_v21_manifest_evidence",
