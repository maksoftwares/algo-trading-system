...
PACKAGE_FILES = (
    ...
    "PREREGISTRATION.md",
    "requirements.txt",
    "config/chop_m15_stationarity_campaign_v21.json",
    "src/__init__.py",
    "src/campaign.py",
    "prepare_manifest.py",
    "lock_contract.py",
...
DEPENDENCIES = (
    ...
    "../chop-stationarity-campaign-v20/outputs/CHOP_STATIONARITY_V20_RESULT.json",
    "../chop-stationarity-campaign-v20/outputs/CHOP_STATIONARITY_V20_METRICS.csv",
    "../chop-m30-dukascopy-portability-v1/outputs/CHOP_M30_DUKASCOPY_RESULT.json",
)
...
def main() -> int:
    config = json.loads(
        (ROOT / "config" / "chop_m15_stationarity_campaign_v21.json").read_text(
            encoding="utf-8"
        )
    )
    ...
    if lock_path.exists():
        raise FileExistsError("V21 contract lock already exists")
    payload: dict[str, Any] = {
        "schema_version": "xauusd_chop_m15_stationarity_v21_contract",
        ...
        "prior_h1_stationarity_and_m30_chop_outcomes_exposed": True,
