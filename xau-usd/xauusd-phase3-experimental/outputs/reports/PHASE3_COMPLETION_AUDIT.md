...
Overall status: REPO_SIDE_COMPLETE_WITH_WARNINGS_WAITING_REAL_GATES
...
| Offline ledger/simulation exists from Phase 1 would-signal evidence. | PASS | accepted_events=116; status=EXPERIMENTAL_COST_SUSPEND_SCENARIO | C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase3-experimental\outputs\reports\PHASE3_EXPERIMENTAL_SIMULATION.md |
...
| Demo rehearsal checklist and ledger are generated without demo authorization. | PASS | status=SIDE_EXPERIMENT_DEMO_REHEARSAL_READY; events=119; opens=3; blocked=50; can_start_real_demo=False | C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase3-experimental\outputs\reports\PHASE3_DEMO_REHEARSAL_CHECKLIST.md |
| Phase 3 to demo handoff is generated without demo authorization. | PASS | status=READY_FOR_REVIEW_WAITING_REAL_GATES; phase2=PENDING; can_start_demo_now=False | C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase3-experimental\outputs\reports\PHASE3_TO_DEMO_HANDOFF.md |
...
| Phase 3 manifest exists and records the current review/worktree state. | WARN | manifest=DIRTY_WORKTREE; clean=False | C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase3-experimental\outputs\reports\PHASE3_EXPERIMENTAL_MANIFEST.md |
...
| --- | --- | --- | --- |
| VPS first-day verification | PENDING | `C:\Users\ZHAO ZHU INFORMATION\Downloads\algo-trading-system\xau-usd\xauusd-phase1\outputs\reports\PHASE2_VPS_FIRST_DAY_VERIFICATION.md` status is PENDING; required PASS. | For the selected runtime host, capture NTP/time-sync, backup, recovery-login, periodic scheduler, MT5 path, compile, startup, decision, and health evidence. |
