...
| entry_exit_proxy median net R | 0.2805 |
| p95_fresh_proxy median net R | 0.1894 |
| stress_2x_p95_proxy median net R | -0.1127 |
| entry_exit_proxy SUSPEND_FAMILY rows | 22 |
| p95_fresh_proxy SUSPEND_FAMILY rows | 48 |
| stress_2x_p95_proxy SUSPEND_FAMILY rows | 106 |
| Stress suspend family events | 59 |
| Cost-gate review | REVIEW_READY |
| Cost-gate 0.25R blocked families | 30 |
| Spread P95 points | 75.0 |
| Kill-state summary | {'COST_WATCH': 2, 'NORMAL': 51, 'SUSPEND_FAMILY': 12} |
| De-dup audit | REVIEW_READY |
| De-dup classifications | {'SAME_BAR_DISTINCT_LEVEL': 1, 'TRUE_DUPLICATE': 64} |
| Paper-shadow status | SIDE_EXPERIMENT_PAPER_SHADOW_READY_WITH_COST_BLOCKS |
| Paper-shadow would-open | 53 |
| Paper-shadow cost-review opens | 2 |
| Paper-shadow blocked suspend | 12 |
| Paper-shadow observer no-exposure | 51 |
| Paper-shadow monthly estimate | 263.17 |
| Shadow lifecycle status | SIDE_EXPERIMENT_SYNTHETIC_LIFECYCLE_READY |
| Shadow lifecycle synthetic opens | 53 |
| Shadow lifecycle net R | -10.9699 |
| Shadow lifecycle max DD R | -12.4405 |
| Shadow lifecycle risk locks | {'NORMAL': 28, 'SYNTHETIC_DAILY_LOCK': 83, 'SYNTHETIC_DEFENSIVE': 5} |
...
| Lifecycle guard net improvement R | 7.3896 |
| Lifecycle guard DD improvement R | 8.8602 |
| Demo rehearsal status | SIDE_EXPERIMENT_DEMO_REHEARSAL_READY |
| Demo rehearsal events | 119 |
| Demo rehearsal shadow opens | 3 |
| Demo rehearsal blocked | 50 |
