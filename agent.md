...
- 2026-05-28 Phase 3 experimental sandbox:
  ...
  - Phase 3 outputs: `xau-usd\xauusd-phase3-experimental\outputs\reports\PHASE3_EXPERIMENTAL_STATUS.md`, `PHASE3_EXPERIMENTAL_SIMULATION.md`, `PHASE3_EXPERIMENTAL_LEDGER.csv`, `PHASE3_SUSPEND_FAMILY_REVIEW.md`, `PHASE3_SUSPEND_FAMILY_ROWS.csv`, `PHASE3_EXPERIMENTAL_SAFETY_REPORT.md`, and `PHASE3_EXPERIMENTAL_MANIFEST.md`.
