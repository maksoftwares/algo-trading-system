...
- Latest D2 result after adding `symbol_round_sweep_reversal_v0`: PASS. `breakout_retest` remained the family winner across 25 non-empty matrix-ledger candidates, White Reality Check p-value 0.0200, max pairwise SPA p-value 0.0326.
