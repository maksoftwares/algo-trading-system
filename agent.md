...
- Latest independent-candidate hypothesis file: `xau-usd\xauusd-phase0\docs\hypothesis_h1_vix_term_structure_inversion_followthrough_v0.md`.
...
- Latest independent-candidate matrix summary: `xau-usd\xauusd-phase0\docs\H1_VIX_TERM_STRUCTURE_INVERSION_FOLLOWTHROUGH_V0_FIRST_PASS.md`.
- Latest independent-candidate result-producing run status: rejected. `h1_vix_term_structure_inversion_followthrough_v0` produced 897 total cost-cell trades, 9/9 trade-count cells, max zero-trade months 2, but 0/9 PF cells reached 1.30. Best PF was only 1.0207 and Pepperstone was materially negative. Do not proceed to deciles or tune v0.
- Latest independent-candidate smoke command: `phase0 run-research-candidate-smoke --expert h1_vix_term_structure_inversion_followthrough_v0 --hypothesis-file docs/hypothesis_h1_vix_term_structure_inversion_followthrough_v0.md`.
- Latest independent-candidate smoke result: PASS. It generated 4 synthetic signals, produced a valid synthetic plan, and confirmed the hypothesis hash lock. The follow-up real matrix rejected the VIX/VXV term-structure inversion followthrough sample.
...
- Hypothesis timeframe coverage by entry/decision cadence: `M5_M15=30`, `M30_H1=65`, `H4_D1=26`, `W1_plus=1`. The real-yield macro blocker, H1 FXY/UUP, FXF/UUP, FXE/UUP, CYB/UUP, FXA/UUP, official FRED CNY-dollar FX rotation, H1 tick-volume participation-flow lane, H1 month-turn calendar-flow lanes, H1 XME/SPY metals-mining lane, H1 ACWX/SPY global ex-US lane, H1 EEM/SPY EM-risk lane, H1 XLE/XLU energy-defensive lane, H1 SLV/GLD precious-beta lane, H1 GLD/SPY safe-haven rotation lane, H1 IWM/SPY size-risk lane, H1 QQQ/SPY growth-risk lane, H1 BTC crypto risk-pressure lane, H1 real-yield/dollar shock lanes, broker-consistent EURUSD/USDJPY H1 dollar-pressure lanes, AUDJPY/USDJPY FX carry-rotation lane, EURJPY/USDJPY FX risk-rotation lane, TLT/UUP traded rates-dollar pressure lanes, TLT/SHY duration-rotation lane, SPY/TLT traded ETF risk-rotation lane, TIP/IEF traded ETF real-yield rotation lane, DBC/UUP broad-commodity versus dollar lane, DBB/UUP industrial-metals versus dollar lane, USO/UUP oil-dollar lane, HYG/IEF credit-risk rotation lane, XLU/XLK defensive-sector rotation lane, XLP/XLY consumer-rotation lane, XLF/XLU financials-defensive rotation lane, XLI/XLU cyclical-defensive rotation lane, GVZ options-implied-volatility lane, VIX equity-risk/reversal/followthrough lanes, VIX/VXV term-structure lane, GVZ/VIX volatility-premium lane, MOVE/VIX bond-volatility lane, GC/XAU basis lane, GC momentum lane, COT continuation lane, GLD ETF flow reversal/flow momentum lanes, NFCI/ANFCI financial-conditions lane, T5YIE/T10YIE breakeven-inflation lane, DGS2/DGS10/T10Y2Y Treasury curve lane, BAA10Y/AAA10Y credit-spread lane, fixed AI-style macro-composite lanes, USEPUINDXD policy-uncertainty lane, standardized US macro event-regime lane, ETF-relative lanes, and H4 US-session liquidity-reversal lane are now cleared; all locked independent first passes remain rejected. No independent candidate has passed Phase 0 first pass yet.
