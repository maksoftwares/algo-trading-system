...
- Latest independent-candidate hypothesis file: `xau-usd\xauusd-phase0\docs\hypothesis_h1_credit_spread_shock_followthrough_v0.md`.
...
- Latest independent-candidate matrix summary: `xau-usd\xauusd-phase0\docs\H1_CREDIT_SPREAD_SHOCK_FOLLOWTHROUGH_V0_FIRST_PASS.md`.
- Latest independent-candidate result-producing run status: rejected. `h1_credit_spread_shock_followthrough_v0` produced 2,070 total cost-cell trades, 9/9 trade-count cells, max zero-trade months 2, and 0/9 PF cells reached 1.30. Pepperstone was positive below threshold, while Capital.com and Dukascopy were negative. Do not proceed to deciles or tune v0.
- Latest independent-candidate smoke command: `phase0 run-research-candidate-smoke --expert h1_credit_spread_shock_followthrough_v0 --hypothesis-file docs/hypothesis_h1_credit_spread_shock_followthrough_v0.md`.
- Latest independent-candidate smoke result: PASS. It generated 1 synthetic signal, produced a valid synthetic plan, and confirmed the hypothesis hash lock. The follow-up real matrix rejected the H1 credit-spread shock follow-through sample.
...
- Hypothesis timeframe coverage by entry/decision cadence: `M5_M15=30`, `M30_H1=74`, `H4_D1=26`, `W1_plus=1`. The real-yield macro blocker, H1 FXY/UUP, FXF/UUP, FXE/UUP, CYB/UUP, FXA/UUP, official FRED CNY-dollar pressure lanes, H1 tick-volume participation-flow lane, H1 month-turn calendar-flow lanes, H1 XME/SPY metals-mining lane, H1 ACWX/SPY global ex-US lane, H1 EEM/SPY EM-risk lane, H1 XLE/XLU energy-defensive lane, H1 SLV/GLD precious-beta lane, H1 GLD/SPY safe-haven rotation lane, H1 IWM/SPY size-risk lane, H1 QQQ/SPY growth-risk lane, H1 BTC crypto risk-pressure lane, H1 real-yield/dollar shock lanes, broker-consistent EURUSD/USDJPY H1 dollar-pressure lanes, AUDJPY/USDJPY FX carry-rotation lane, EURJPY/USDJPY FX risk-rotation lane, TLT/UUP traded rates-dollar pressure lanes, TLT/SHY duration-rotation lane, SPY/TLT traded ETF risk-rotation lane, TIP/IEF traded ETF real-yield rotation lane, DBC/UUP broad-commodity versus dollar lane, DBB/UUP industrial-metals versus dollar lane, USO/UUP oil-dollar lane, HYG/IEF credit-risk rotation lane, XLU/XLK defensive-sector rotation lane, XLP/XLY consumer-rotation lane, XLF/XLU financials-defensive rotation lane, XLI/XLU cyclical-defensive rotation lane, GVZ options-implied-volatility lane, VIX equity-risk/reversal/followthrough lanes, VIX/VXV term-structure lane, GVZ/VIX volatility-premium lane, MOVE/VIX bond-volatility lane, GC/XAU basis lane, GC momentum lane, COT continuation lane, GLD ETF flow reversal/flow momentum lanes, NFCI/ANFCI financial-conditions lane, T5YIE/T10Y2Y breakeven-inflation H4/H1 lanes, DGS2/DGS10/T10Y2Y Treasury curve H4/H1 lanes, BAA10Y/AAA10Y credit-spread H4/H1 lanes, fixed AI-style macro-composite lanes, USEPUINDXD policy-uncertainty H4/H1 lanes, standardized US macro event-regime lane, ETF-relative lanes, and H4 US-session liquidity-reversal lane are now cleared; all locked independent first passes remain rejected. No independent candidate has passed Phase 0 first pass yet.
